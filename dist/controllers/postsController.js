...
var PostsController = /** @class */ (function () {
    function PostsController() {
        ...
        this.getPosts = function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var category_1, posts, result;
            return __generator(this, function (_a) {
                try {
                    category_1 = request.body.category;
                    posts = [
                    ...
                    result = posts.filter(function (e) { return category_1.includes(e.category); });
